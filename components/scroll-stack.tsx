...
export const ScrollStackItem = ({ children, itemClassName = '' }: any) => (
  <div
    className={`scroll-stack-card relative w-full h-auto my-8 box-border origin-top will-change-transform ${itemClassName}`.trim()}
    style={{
...
const ScrollStack = ({
  ...
  const updateCardTransforms = useCallback(() => {
    ...
    cardsRef.current.forEach((card, i) => {
      ...
      const pinEnd = endElementTop - containerHeight + 100;
  ...
  return (
    <div className={containerClassName} ref={scrollerRef} style={containerStyles as any}>
      <div className="scroll-stack-inner pb-[100vh] overflow-visible">
        {children}
